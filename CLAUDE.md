...
- **Controllers**: Located in `Controller/` package (note: non-standard uppercase package name, outside the `com.example.iaf` component scan base package)

## Key Paths

- `src/main/java/com/example/iaf/` — Spring Boot application entry point
